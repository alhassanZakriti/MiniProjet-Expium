...
const Settings = () => {
  ...
  const data :{firstname : string ; lastname : string; username: string ; password : string ; email: string }= {
    firstname: "Al Hassan",
    lastname : "Zakriti",
  ...
  return (
    <div className="content-area">
      <form onSubmit={handleSubmit(submitForm)} className="form-edit">
        <div className="pic">
          <img src={Mypic} alt="img" className="pic-edit"/>
          <BiSolidImageAdd className="icon-upload"/>
          <input type="file" name="uploadImg" id="upImg" />
        </div>
        ...
        <div className="input-area">
          <input type={isVisible? "password": "text"} className="pw" placeholder="Password" />
