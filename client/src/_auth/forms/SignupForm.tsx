...
const SignupForm = () => {
  ...
  const fillingError = (data:any) =>{
    if(!( (data.username.length() ==0) && (data.firstname.length() ==0) && (data.lastname.length() ==0) && (data.email.length() ==0))){
    ...
    <div className="hero-left">
      ...
      <form onSubmit={handleSubmit(submitForm)} className="auth-form">
        ...
        <div className="input-area">
          <input type={isVisible? "password": "text"} onChange={handleChange} className="pw" placeholder="Password" />
